<html>
  ...
  <head>
    <title> Manager Signup | Foodika </title>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Foodika </span></h1>
     <br>
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><i class="fas fa-user"></label></i>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><i class="far fa-envelope"></i></label>
